...
const projects = [
  {
    ...
    description:
      "Community focused app to help connect people with helpers who can assist them with everyday tasks.",
    img: "Prework.png",
  },
  {
    id: 2,
    ...
    description:
      "Social media app for people to record their dreams and nightmares to share with others.",
  ...
  },
  {
    ...
    description:
      "A website that allows users to see how far away the International Space Station is from their location.",
